    ...
    <div className="pb-24 pt-8">
      ...
      <div 
        ...
        dangerouslySetInnerHTML={{ 
          // bodyが無ければ「本文なし」と表示して確認できるようにする
          __html: blog.body ? blog.body : "<p style='color:red;'>※本文データが取得できませんでした。microCMSのフィールドIDが 'body' か確認してください。</p>" 
        }} 
      />
      ...
      <div className="mt-24 pt-12 border-t border-gray-200 flex flex-col items-center gap-8">
        ...
        <div className="w-full flex justify-between items-center mt-8 pt-8 border-t border-gray-100">
           ...
           <a href="mailto:contact@newlogos.com?subject=訂正の提案" className="text-xs font-bold text-gray-500 hover:text-red-600">
             [ 訂正を提案 ]
           </a>
        </div>
      </div>
